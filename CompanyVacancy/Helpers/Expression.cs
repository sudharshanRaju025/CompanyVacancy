...
namespace CompanyVacancy
{
    public static class SearchQueryParser
    {
        public static string ParseToDynamicLinq(string input)
        {
            ...
            string[] knownJobRoles = { "Developer", "Analyst", "Tester", "Researcher", "Designer", "Coordinator", "Architect", "HR","amazon" };
        ...
        static string ParseConditionPart(string part)
            {
                ...
                string[] startWords = { "Vacancies", "Job_roles", "Need_Factor", "Location", "Vacancy_Factor", "Name", "name","job role","located" };
                string[] endwords = { "Developer", "Analyst", "Tester", "HR", "Researcher", "Designer", "Coordinator", "Architect","amazon","Amazon"};
                ...
                foreach (var kvp in dict)
                {
                    ...
                    if (values.Count == 2)
                    {
                        ...
                        return operation switch
                        {
                            ...
                            "out side " => $"{key} > {FormatValue(operand)}",
