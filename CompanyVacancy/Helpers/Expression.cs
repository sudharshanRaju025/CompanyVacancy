    ...
    public static class SearchQueryParser
    {
        public static string ParseToDynamicLinq(string input)
        {
            ...
            string[] knownJobRoles = {
                ...
                "embedded engineer","automation","electrical engineer","data analyst","dotnet"
            };
        ...
        static string ParseConditionPart(string part)
        {
            ...
            string[] startWords = {
                "Vacancies", "Job_roles", "Need_Factor", "Location", "Vacancy_Factor","locate",
                "Name", "name", "job role", "located", "company", "companyname", "company name", "organization","company Names","compnaies","company names"
            };
            ...
            if (startIndex != -1)
            {
                ...
                // Alias mapping updated to map all company aliases to all columns
